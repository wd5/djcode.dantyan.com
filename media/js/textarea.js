jQuery(function(){
	$('#id_content').tinymce({
		...
		script_url : '/media/js/tiny_mce/tiny_mce_src.js?'+utils.rand(),
		
		mode : "specific_textareas", // only specific textareas
        editor_selector : "mceEditor", // specified by the mceEditor class
		theme : "advanced",
		plugins : "table,save,advhr,advimage,advlink,pagebreak,uploadimage",
        ...
        theme_advanced_buttons2 : "cut,copy,paste,separator,search,replace,image,link,anchor,separator,tablecontrols,|,pagebreak,|,uploadimage",
